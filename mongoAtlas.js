...
//     title: 'A Review of Roman History',
//     text: 'Back in the day, there was a guy named Julius Ceasar. And he was an awewsome general that kicked major butt. In fact he was so awesome that all his soldiers loved him and pledged loyalty to him. With the help of his men, he took power of Rome.',
//     author: 'Corey S',
...
// db.posts.findOne({id: String(db.posts.count())})

// *** Update the new blog post with a new title ***
// db.posts.updateOne(
//     {id: String(db.posts.count())}, 
//     {$set: {title: 'Brief Overview of Roman History v2'}})
